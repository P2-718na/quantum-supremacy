...
parser.add_argument('--qbits', type=int, default=27, help="Number of qubits.")
parser.add_argument('--shots', type=float, default=int(1e5), help="Number of shots.")
...
depth = (5 * qbits) ** 2
method = "automatic"  # Simulation method
max_qbits = 53  # Maximum number of qubits

# Result paths
base_folder     = f"../runs-noisy/{qbits}qbits/seed{args.seed}-shots1e{int(log(shots, 10))}/"
...
# Setup simulator
#service = QiskitRuntimeService(name="personal-PAID")
#print(service.backends())
#backend = service.backend("ibm_brisbane")
simulator = AerSimulator.from_backend(FakeBrisbane())
simulator.set_options(device='GPU', method=method)
